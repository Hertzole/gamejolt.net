...
namespace GameJolt.NET.Tests
{
	...
	public sealed class FriendsTest : BaseTest
	{
		...
		[Test]
		public async Task Fetch_WithList_Guards()
		{
			await AssertThrowsAsync<ArgumentNullException>(() => GameJoltAPI.Friends.GetFriendsAsync(null!),
				e => MustNotBeNullPredicate<IList<int>>(e, "results"));
		}
	}
}
